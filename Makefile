#############################################################################
# Makefile for building: PaOSerra.app/Contents/MacOS/PaOSerra
# Generated by qmake (3.1) (Qt 6.6.1)
# Project:  PaOSerra.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile PaOSerra.pro
#############################################################################
...
DESTDIR       = 
TARGET        = PaOSerra.app/Contents/MacOS/PaOSerra
...
EXPORT__PRO_FILE_ = /Users/filipporizzolo/Documents/UniPD/anno3/recupero2/pao/PaOSerra/PaOSerra.pro
...
PaOSerra.app/Contents/MacOS/PaOSerra:  $(OBJECTS)  
	@test -d PaOSerra.app/Contents/MacOS/ || mkdir -p PaOSerra.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: PaOSerra.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.1/share/qt/mkspecs/common/macx.conf \
...
PaOSerra.app/Contents/PkgInfo: 
	@test -d PaOSerra.app/Contents || mkdir -p PaOSerra.app/Contents
	@$(DEL_FILE) PaOSerra.app/Contents/PkgInfo
	@echo "APPL????" > PaOSerra.app/Contents/PkgInfo
PaOSerra.app/Contents/Info.plist: 
	@test -d PaOSerra.app/Contents || mkdir -p PaOSerra.app/Contents
	@$(DEL_FILE) PaOSerra.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,it.filipporizzolo.PaOSerra,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},it.filipporizzolo.PaOSerra,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,PaOSerra,g" -e "s,@LIBRARY@,PaOSerra,g" -e "s,\$${EXECUTABLE_NAME},PaOSerra,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >PaOSerra.app/Contents/Info.plist

all: Makefile \
		PaOSerra.app/Contents/PkgInfo \
		PaOSerra.app/Contents/Info.plist PaOSerra.app/Contents/MacOS/PaOSerra
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/PaOSerra/bin || mkdir -p $(INSTALL_ROOT)/opt/PaOSerra/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/PaOSerra/bin/PaOSerra.app
	
	$(QINSTALL) PaOSerra.app $(INSTALL_ROOT)/opt/PaOSerra/bin/PaOSerra.app
	-$(STRIP) $(INSTALL_ROOT)/opt/PaOSerra/bin/PaOSerra.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/PaOSerra/bin/PaOSerra.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/PaOSerra/bin/ 
